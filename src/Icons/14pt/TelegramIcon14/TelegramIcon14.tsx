...
export interface TelegramIcon14Props {
  /**
   *  Variant of button
   */
  fill?: string;
 ...
 */
const TelegramIcon14 = ({ fill, purposeLabel }:TelegramIcon14Props) => (
  <AccessibleIcon.Root
...
TelegramIcon14.defaultProps = {
  fill: '#000000',
  purposeLabel: 'Telegram Icon',
};

export default TelegramIcon14;
